...
const isArmstrongNumber = useCallback((number) => {
...
const App = () => {
  ...
  const isArmstrong = useMemo(() => isArmstrongNumber(num), [isArmstrongNumber, num]);
  ...
  return (
    <div className="App">
      <input id='input' value={num} onChange={handleInputChange} />
